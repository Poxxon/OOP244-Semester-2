...
namespace seneca {
    ...
    int seneca::Date::mdays() const {
    int days[] = { 31,28,31,30,31,30,31,31,30,31,30,31 };
    return days[m_mon] + int((m_mon == 1) * (((m_year % 4 == 0) && (m_year % 100 != 0)) || (m_year % 400 == 0)));
}
    ...
    const char* Date::dateStatus() const {
        static const char* DATE_ERROR[] = { "No Error", "cin Failed", "Bad Year Value", "Bad Month Value", "Bad Day Value" };
